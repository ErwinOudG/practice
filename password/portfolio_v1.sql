...
--
-- Host: localhost
-- Generation Time: Jan 02, 2018 at 10:33 AM
...
CREATE TABLE `role` (
  ...
  `rolename` varchar(30) CHARACTER SET utf8 NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Dumping data for table `fgb_menu`
--
...
INSERT INTO `menuitems` (`menuid`, `itemname`, `itemorder`, `itemid`, `itemtype`) VALUES
(2, 'Home', 1, 1, ''),
(2, 'POP', 2, 2, ''),
(2, 'CV', 3, 3, ''),
(2, 'Certificaten', 4, 4, ''),
...
--
-- Indexes for table `fgb_menu`
--
ALTER TABLE `menu`
  ADD UNIQUE KEY `menuname` (`menuname`);

--
-- Indexes for table `fgb_menu_items`
--
